...
class DefaultOperationTableTest extends AbstractUnitTestCase
{
    ...
    {
        yield [[2, 3], new MultiplicationOperation(), [['', 2, 3], [2, 4, 6], [3, 6, 9]]];
        yield [[2, 3], new AdditionOperation(), [['', 2, 3], [2, 4, 5], [3, 5, 6]]];
        yield [[2, 3], new ExponentiationOperation, [['', 2, 3], [2, 4, 8], [3, 9, 27]]];
    }
